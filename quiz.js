class Quiz{
    ...
    controlNumberOfQuestions(player, valueFromUser, button, inputDiv){
        ...
        this.numberOfQuestions = valueFromUser
          console.log("control", valueFromUser)
          if(this.numberOfQuestions >= 5 && this.numberOfQuestions <= 10){  
              ...
              setTimeout( () => this.displayQuestions(player), 3000);
    ...
    endOfTheQuizGame(player){
        ...
        if (this.questionsAnswered == this.numberOfQuestions){
            ...
            let message = ''
            if (player.points/(this.numberOfQuestions*10) < 0.8 && player.points/(this.numberOfQuestions*10) >= 0.4){
                message = '"You Are On the Right Track! Keep Studying"'
            }else if(player.points/(this.numberOfQuestions*10)<0.4){
                message = '"Ya Dumb!"'
